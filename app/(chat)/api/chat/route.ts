...
import { notionRetrieveABlock } from '@/lib/ai/tools/notion-retrieve-a-block';
import { notionUpdateABlock } from '@/lib/ai/tools/notion-update-a-block';
import { notionDeleteABlock } from '@/lib/ai/tools/notion-delete-a-block';
...
import { notionRetrieveAComment } from '@/lib/ai/tools/notion-retrieve-a-comment';
      ...
      execute: (dataStream) => {
        const result = streamText({
          ...
          tools: {
            ...
            notionRetrieveABlock: notionRetrieveABlock({
              notionToken: notionToken ?? null,
            }),
            notionUpdateABlock: notionUpdateABlock({
              notionToken: notionToken ?? null,
            }),
            ...
            notionPatchPage: notionPatchPage({
              notionToken: notionToken ?? null,
            }),
            ...
            notionRetrieveAComment: notionRetrieveAComment({
              notionToken: notionToken ?? null,
            }),
            notionCreateAComment: notionCreateAComment({
              notionToken: notionToken ?? null,
            }),
            notionRetrieveADatabase: notionRetrieveADatabase({
              notionToken: notionToken ?? null,
            }),
